...
public class ViewAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
        ...
        jLabel12.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Autor");

        jLabel13.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Año publicacion");

        jLabel14.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
        ...
        jButton5.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
        ...
        tableLibros.setBackground(new java.awt.Color(153, 153, 153));
        ...
        tableListDeLibrosPrestados.setBackground(new java.awt.Color(153, 153, 153));
        tableListDeLibrosPrestados.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        tableListDeLibrosPrestados.setFont(new java.awt.Font("Viner Hand ITC", 0, 12)); // NOI18N
        tableListDeLibrosPrestados.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel16.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
        ...
        jButton7.setFont(new java.awt.Font("Viner Hand ITC", 1, 12)); // NOI18N
    ...
    private void agregarUsuariosTable() {
        ...
        model.setRowCount(0);
        Usuario.listaDeUsarios.forEach(usuario -> {
    ...
    private void agregarLibrosPrestadosNoDevueltosTable() {
        ...
        Prestamo.listaDePrestamos.forEach(prestamo -> {
            if (prestamo.getFechaDevolucion() == null) {
                Libro libro = libroControlador.buscar(prestamo.getIsbn());
                Usuario usuario = usuarioControlador.buscarUs(prestamo.getUsuarioID());
                model.addRow(new Object[]{prestamo.getId(), prestamo.getUsuarioID(),
                    usuario.getNombre(), prestamo.getIsbn(), libro.getTitulo(), prestamo.getFechaPrestamo(),
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        nuevoUsuario.setRoleID(checkbox1.getState() ? 2 : 3);

        usuarioControlador.create(nuevoUsuario);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (id == 0) {
            ...
            boolean usuarioActualizado = usuarioControlador.update(usuarioActualizar);
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        ...
        libroControlador.create(nuevoLibro);
        Libro.listaDeLibros.clear();
        Libro.listaDeLibros.addAll(libroControlador.list());
        agregarLibrosTable();
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        boolean existePrestamo = Prestamo.listaDePrestamos.stream().anyMatch(prestamo -> prestamo.getIsbn() == isbn);

        if (existePrestamo) {
            JOptionPane.showMessageDialog(null, "No se puede eliminar el libro, ya que tiene prestamos asociados");
            return;
        }
        libroControlador.delete(isbn);
        Libro.listaDeLibros.clear();
        Libro.listaDeLibros.addAll(libroControlador.list());
        agregarLibrosTable();
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        libroControlador.devolucion(isbn);
        Prestamo.listaDePrestamos.clear();
        Prestamo.listaDePrestamos.addAll(prestamoController.list());
        agregarLibrosPrestadosNoDevueltosTable();
